...
person_number = {'1;SG', '1;PL', '2;SG', '2;PL', '3;SG;MASC', '3;SG;FEM', '3;PL;MASC',
                 '3;PL;FEM'}  # ,  '3;PL;NEUT','3;SG;NEUT',}

nom_prons = {'1;SG': 'je',  # '1;SG;MASC': 'je', '1;SG;FEM': 'je',
             '1;PL': 'nous', '2;SG': 'tu', '2;PL': 'vous', '3;SG;MASC': 'il', '3;SG;FEM': 'elle', '3;PL;MASC': 'ils',
             '3;PL;FEM': 'elles'}  # ,  '3;PL;NEUT':'ce', '3;SG;NEUT':'cela'}

acc_prons = {'1;SG': 'me', '1;PL': 'nous', '2;SG': 'te', '2;PL': 'vous', '3;SG;MASC': 'le', '3;SG;FEM': 'la',
             "3;PL": "les"}  # , "3;PL": "les"} # NB: "3;PL;MASC": "les" and "3;PL;FEM" could be normalized to "3;PL" (but then must handle acc_prons[pn] errors)

dat_prons = {'1;SG': 'me', '1;PL': 'nous', '2;SG': 'te', '2;PL': 'vous', '3;SG;MASC': 'lui', '3;SG;FEM': 'lui',
             '3;PL': 'leur'}  # '3;PL;MASC':'leur', '3;PL;FEM':'leur'}

reflex_prons = {'1;SG': 'me', '1;PL': 'nous', '2;SG': 'te', '2;PL': 'vous', '3;SG': 'se',
                '3;PL': 'se'}  # '3;PL;MASC':'leur', '3;PL;FEM':'leur'}
...
prepos = {'a': '', 'd': 'à', 'c': 'avec', 'g': 'of', 'b': 'from', 'f': 'for', 'l': 'on', 's': 'at', 't': 'about',
          'i': 'in'}
...
non_lemma_words |= {'will', "don't", 'do', 'be', 'would', 'not', 'did', "didn't", 'does', "doesn't", '?', "I'm",
                    "you're",
                    "we're", "they're", "he's", "she's", "it's", "haven't", "hasn't", "hadn't", "wouldn't", "won't",
                    "wasn't", "weren't",
                    "I've", "you've", "we've", "they've", "I'd", "you'd", "we'd", "they'd", "he'd", "she'd", "I'll",
                    "you'll", "we'll",
...
auxiliary_dict = {"a": {
    ...
    "IND;PST;IPFV": {'1;SG': 'avais', '2;SG': 'avais', '3;SG': 'avait', '1;PL': 'avions', '2;PL': 'aviez',
                     '3;PL': 'avaient'},
    "IND;PST;PFV;LGSPEC1": {'1;SG': 'eus', '2;SG': 'eus', '3;SG': 'eut', '1;PL': 'eûmes', '2;PL': 'eûtes',
                            '3;PL': 'eurent'},
    "COND;PST": {'1;SG': 'aurais', '2;SG': 'aurais', '3;SG': 'aurait', '1;PL': 'aurions', '2;PL': 'auriez',
                 '3;PL': 'auraient'},
},
    "e": {"IND;PRS": {'1;SG': "suis", '2;SG': 'es', '3;SG': 'est', '1;PL': 'sommes', '2;PL': 'êtes', '3;PL': "sont"},
          "IND;FUT": {'1;SG': 'serai', '2;SG': 'seras', '3;SG': 'sera', '1;PL': 'serons', '2;PL': 'serez',
                      '3;PL': 'seront'},
          "IND;PST;IPFV": {'1;SG': 'étais', '2;SG': 'étais', '3;SG': 'était', '1;PL': 'étions', '2;PL': 'étiez',
                           '3;PL': 'étaient'},
          "IND;PST;PFV;LGSPEC1": {'1;SG': 'fus', '2;SG': 'fus', '3;SG': 'fut', '1;PL': 'fûmes', '2;PL': 'fûtes',
                                  '3;PL': 'furent'},
          "COND;PST": {'1;SG': 'serais', '2;SG': 'serais', '3;SG': 'serait', '1;PL': 'serions', '2;PL': 'seriez',
                       '3;PL': 'seraient'}
          }
}
        ...
        if case[0] == "a":
            ...
            try:
                ...
                return (
                    ...
                    [pron_subject_feat for _ in GET_LEFF_PP[pron_argument_feat]],
                    # subject feat is not expanded cause the agreement will be with the argument
                    None if pron_argument_feat is None else [f'{pron_argument_feat[0]};{feature}' for feature in
                                                             GET_LEFF_PP[pron_argument_feat]]
                )
            except:
...
def append_declarative_sent(new_table, seed_full_feature, form, subject, case, seed_full_form, _pron_feat=None,
                            pron=None, aux=None):
    # features
...
def append_question(new_table, _pron_feat, seed_full_feature, form, subject, case, seed_full_form, pron=None, aux=None):
    ...
    if aux is None:
        # le dites?
        pron, subject = phonological_constrain_pronons(pron=pron, form=form, type=case, subject=subject)
        full_form = f"{seed_full_form}{pron}{form}{get_question_phonological_link(before_subject=form, subject=subject,
                                                                                  case=case)}{subject} ?"
    else:
        pron, subject = phonological_constrain_pronons(pron=pron, form=aux, type=case, subject=subject)
        full_form = f"{seed_full_form}{pron}{aux}{get_question_phonological_link(before_subject=aux, subject=subject,
                                                                                 case=case)}{subject} {form} ?"
...
def append_negation(new_table, _pron_feat, seed_full_feature, form, subject, case, seed_full_form, pron=None, aux=None):
    ...
    if aux is None:
        ...
        pron, subject = phonological_constrain_pronons(pron=pron, form=aux, type=case, subject=subject)
        full_form = f"{seed_full_form}{subject}{get_ne(pron=pron, type=case,
                                                       form=aux)}{pron}{aux + ' ' if aux is not None else ''}pas {form}."

    new_table[full_feature] = full_form


def append_question_and_negation(new_table, _pron_feat, seed_full_feature, form, subject, case, seed_full_form,
                                 pron=None, aux=None):
    # feature
    if case in ["a", "d", "l", "g", "r"]:
        assert pron is not None
    ...
    if aux is None:
        pron, subject = phonological_constrain_pronons(pron=pron, form=form, type=case, subject=subject)
        full_form = f"{seed_full_form}{get_ne(pron=pron, type=case,
                                              form=form)}{pron}{form}{get_question_phonological_link(
            before_subject=form, subject=subject, case=case)}{subject}pas ?"
    else:
        pron, subject = phonological_constrain_pronons(pron=pron, form=aux, type=case, subject=subject)
        full_form = f"{seed_full_form}{get_ne(pron=pron, type=case,
                                              form=aux)}{pron}{aux}{get_question_phonological_link(before_subject=aux,
                                                                                                   subject=subject,
                                                                                                   case=case)}{subject}pas {form} ?"
    new_table[full_feature] = full_form


def append_4_types_of_sentences(new_table, _pron_feat, seed_full_feature, form, subject, case, seed_full_form,
                                pron=None, aux=None):
...
def append_question_sent_bi_pron(new_table, seed_full_feature, form, subject, case, seed_full_form,
    ...
    pronon_pairs, tonique_1 = two_pronouns_order_and_phonological_constrains(pron_0=pron_0, pron_1=pron_1,
                                                                             ...
                                                                             type=case)
    if aux is None:
        new_table[full_feature] = f"{seed_full_form}{pronon_pairs}{form}{get_question_phonological_link(
            before_subject=form, subject=subject, case=case)}{subject}{tonique_1} ?"
    else:
        new_table[full_feature] = f"{seed_full_form}{pronon_pairs}{aux}{get_question_phonological_link(
            before_subject=aux, subject=subject, case=case)}{subject} {form}{tonique_1} ?"
...
def append_neg_sent_bi_pron(new_table, seed_full_feature, form, subject, case, seed_full_form, _pron_feat_0=None,
    ...
    if aux is None:
        ...
        new_table[full_feature] = f"{seed_full_form}{subject} {get_ne(pron=_pron_feat_0, type=case,
                                                                      form=form)}{pronon_pairs}{form} pas{tonique_1}."
    else:
        new_table[full_feature] = f"{seed_full_form}{subject} {get_ne(pron=_pron_feat_0, type=case,
                                                                      form=form)}{pronon_pairs}{aux + ' '}pas {form}{tonique_1}."
...
def append_question_negation_sent_bi_pron(new_table, seed_full_feature, form, subject, case, seed_full_form,
    ...
    if aux is None:
        new_table[full_feature] = f"{seed_full_form}{get_ne(pron=_pron_feat_0, type=case,
                                                            form=form)}{pronon_pairs}{form}{get_question_phonological_link(
            before_subject=form, subject=subject, case=case)}{subject} pas{tonique_1} ?"
    else:
        new_table[full_feature] = f"{seed_full_form}{get_ne(pron=_pron_feat_0, type=case,
                                                            form=form)}{pronon_pairs}{aux}{get_question_phonological_link(
            before_subject=aux, subject=subject, case=case)}{subject} pas {form}{tonique_1} ?"
...
def append_4_types_of_sentences_two_pron(new_table, seed_full_feature, form, subject, case, seed_full_form,
    ...
    append_question_negation_sent_bi_pron(new_table, seed_full_feature, form, subject, case, seed_full_form,
                                          _pron_feat_0=_pron_feat_0, pron_0=pron_0, _pron_feat_1=_pron_feat_1,
                                          pron_1=pron_1,
                                          aux=aux)
...
def two_pronouns_order_and_phonological_constrains(form, _pron_feat_0=None, _pron_feat_1=None, pron_0=None, pron_1=None,
                                                   type="ad", mood=None):
    tonique_1 = ""
            ...
            for i, aspect in enumerate(aspects):
                ...
                for pn in person_number:
                    ...
                    try:
                        ...
                        print(f"Warning: form {form} : {unimorph_match} not found in unimopph so skipping it ")
                        continue
                    ...
                    for _response in responses:
                        ...
                        for i, aux in enumerate(aux_dic[_response]):
                            ...
                            if _response == "0":
                                ...
                                ptcp_pst_ls, pn_ls, _ = get_ptcp_pst_pn_expansion(_response, aux, table, ptcp_pst_table,
                                                                                  None, pn)
                                ...
                                for _pron_feat_0, _pron_0 in prepos_prons[_response[0]].items():
                                    for _pron_feat_1, _pron_1 in prepos_prons[_response[1]].items():
                                        ...
                                        if _response == "ad":
                                            if _pron_feat_0[0] in ['1', '2'] and ";".join(
                                                    _pron_feat_0.split(";")[:1]) == ";".join(
                                                    _pron_feat_1.split(";")[:1]):
                                                # skipping me me, te te..., me nous, nous me...
                                                continue
                                        if _response[0] == "r" and ";".join(_pron_feat_0.split(";")[:2]) != ";".join(
                                                pn.split(";")[:2]):
                                        ...
                                        # SIMPLE TENSES
                                        if mood == "IMP":
                                            if (pn == "1;PL" and _pron_feat_0 == "2;SG") or (
                                                    pn == "1;PL" and _pron_feat_0 == "2;PL"):
                                                continue
                                            ...
                                            _pron_imperatif, tonique_1 = two_pronouns_order_and_phonological_constrains(
                                                _pron_feat_0=_pron_feat_0, _pron_feat_1=_pron_feat_1,
                                                pron_0=_pron_imperatif_0, pron_1=_pron_imperatif_1, form=form,
                                                type=_response, mood=mood)
                                            ...
                                            full_feature = seed_full_feature + f"{cases[
                                                _response[0]]}({_pron_feat_0});" + f"{cases[
                                                _response[1]]}({_pron_feat_1});"
                                            new_table[full_feature] = full_form
                                            full_feature = seed_full_feature + f"{cases[
                                                _response[0]]}({_pron_feat_0});" + f"{cases[
                                                _response[1]]}({_pron_feat_1});NEG;"
                                            ...
                                            _pron_imperatif, tonique_1 = two_pronouns_order_and_phonological_constrains(
                                                _pron_feat_0=_pron_feat_0, _pron_feat_1=_pron_feat_1, pron_0=_pron_0,
                                                pron_1=_pron_1, form=form, type=_response, mood=mood)
                                            full_form = seed_full_form + f"{get_ne(_pron_0, type=_response,
                                                                                   form=form)}{_pron_imperatif} {form} pas{tonique_1} !"
                                            new_table[full_feature] = full_form
                                        ...
                                        ptcp_pst_ls, pn_ls, pn_feat_argument_0_ls = get_ptcp_pst_pn_expansion(_response,
                                                                                                              aux,
                                                                                                              table,
                                                                                                              ptcp_pst_table,
                                                                                                              _pron_feat_0,
                                        ...
                                        # if _response[0] == "a":
                                        #    breakpoint()
                                        for pn_feat_subject, pn_feat_arg_0, ptcp_pst in zip(pn_ls,
                                                                                            pn_feat_argument_0_ls,
                                                                                            ptcp_pst_ls):
                                            seed_full_form = ""

                                            if (pn == "1;PL" and _pron_feat_0 == "1;SG") or (
                                                    pn == "2;PL" and _pron_feat_0 == "2;SG") or (
                                ...
                                for _pron_feat, _pron in prepos_prons[_response].items():
                                    ...
                                    # accordé ptcp_pst
                                    if _response == "r" and ";".join(_pron_feat.split(";")[:2]) != ";".join(
                                            pn.split(";")[:2]):
                                        # in reflexive cases: only "je me..., tu te... "
                                        continue
                                    seed_full_feature = f"{mood};{tense_feature};NOM({pn});"
                                    ...
                                    if mood == "IMP":
                                        ...
                                        full_form = seed_full_form + f"{get_ne(_pron, type=_response, form=form)}{
                                        phonological_constrain_pronons(form=form, pron=_pron, subject='',
                                                                       type=_response)[0]}{form} pas !"
                                        new_table[full_feature] = full_form
                                    ...
                                    ptcp_pst_ls, pn_ls, pn_feat_argument_ls = get_ptcp_pst_pn_expansion(_response, aux,
                                                                                                        table,
                                                                                                        ptcp_pst_table,
                                                                                                        _pron_feat, pn)

                                    for pn_feat_subject, pn_feat_arg, ptcp_pst in zip(pn_ls, pn_feat_argument_ls,
                                                                                      ptcp_pst_ls):
                                        seed_full_form = ""

                                        if (pn == "1;PL" and _pron_feat == "1;SG") or (
                                                pn == "2;PL" and _pron_feat == "2;SG") or (
...
if __name__ == '__main__':
    ...
    with open(
            "/Users/bemuller/Documents/Work/INRIA/dev/mighty_morph_tagging_tool/leff-extract/derivation_pp.json") as read:
        pp = json.load(read)
